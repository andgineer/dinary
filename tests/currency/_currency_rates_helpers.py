...
def nbs_mocks():
    with (
        patch("dinary.adapters.rates.nbs.get_db_rate") as get_db,
        patch("dinary.adapters.rates.nbs.save_db_rate") as save_db,
        patch("dinary.adapters.rates.nbs._fetch_nbs_rate") as fetch_nbs,
    ):
