...
def _setup_system_packages(c, no_swap: bool) -> None:
    ...
    ssh_sudo(c, "apt update && sudo apt install -y python3 python3-pip git curl sqlite3 rclone")
...
def _setup_tunnel(c, setup_tunnel: str, tailscale: bool) -> None:
